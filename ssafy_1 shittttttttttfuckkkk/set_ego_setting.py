...
### YOU NEED F4 -> SIMULATOR NETWORK SETTING -> CONNECT TO EGO_SETTING
...
def talker():
    ...
    ego_setting_msg.camera_index = 1
    ego_setting_msg.ego_index = [1]
    ego_setting_msg.global_position_x = [10.0] 
    ego_setting_msg.global_position_y = [10.0]
    ego_setting_msg.global_position_z = [10.0]
    ego_setting_msg.global_roll = [0.0]
    ego_setting_msg.global_pitch = [0.0]
    ego_setting_msg.global_yaw = [0.0]
    ego_setting_msg.velocity=[10.0]
